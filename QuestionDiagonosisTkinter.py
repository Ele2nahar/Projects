...
training_dataset = pd.read_csv('C:/Users/Ele/OneDrive/Desktop/healthchatbot project/HealthCare-ChatBot-main/Training.csv')
test_dataset = pd.read_csv('C:/Users/Ele/OneDrive/Desktop/healthchatbot project/HealthCare-ChatBot-main/Testing.csv')
...
doc_dataset = pd.read_csv('C:/Users/Ele/OneDrive/Desktop/healthchatbot project/HealthCare-ChatBot-main/doctors_dataset.csv', names = ['Name', 'Description'])
...
class MainForm(Frame):
    ...
    def createWidget(self):
        ...
        self.lblTeam.pack()
        self.lblTeam2=Label(self, text="Sankalp Sharma", bg="white", width = "250", height = "1", font=("Calibri", 13))
        self.lblTeam2.pack()
        self.lblTeam3=Label(self, text="Puneet Ibarit Singh", bg="white", width = "250", height = "1", font=("Calibri", 13))
        self.lblTeam3.pack()
